...
export const AboutPage = () => {
  ...
  const locationString = getLocationString(
    JSON.stringify(selectedTree.geoLocation || [])
  );
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 tree-card__info-grid">
              <div className="space-y-3 tree-card__info-column">
                ...
                {locationString && (
                  <div
                    ...
                    onClick={() => goToLocationPage(selectedTree.EntityId)}
                  >
              ...
              <div className="space-y-3 tree-card__info-column">
                ...
                <div
                  ...
                  onClick={() => goToImagesPage(selectedTree.EntityId)}
                >
                  <span style={{ color: THEME.colors.primary }}>🖼️</span>
                  <span className="font-medium">Images:</span>
                  <span className={THEME.colors.text.body}>View Gallery</span>
                  <span className="ml-auto text-sm text-gray-500">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
            ...
            {expandedTrees.has(selectedTree.EntityId) && (
              ...
              >
                ...
                <DetailSection
                  ...
                  className="grid grid-cols-1 sm:grid-cols-2 gap-4"
                >
                  {Object.entries(treeData.detailedInfo.characteristics).map(
                    ([key, value]) => (
                      <DetailItem
                        key={key}
                        label={key}
                ...
                <DetailSection
                  ...
                  className="grid grid-cols-1 sm:grid-cols-2 gap-4"
                >
                  {Object.entries(treeData.detailedInfo.growthRequirements).map(
                    ([key, value]) => (
                      <DetailItem
                        key={key}
                        label={key}
